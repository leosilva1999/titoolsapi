...
namespace TiTools_backend.Migrations
{
    ...
    [Migration("20251228234321_AddTypeManufacturerAndModelToEquipment")]
    partial class AddTypeManufacturerAndModelToEquipment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiTools_backend.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TiTools_backend.Models.ApplicationUser", null)
                        .WithMany()
